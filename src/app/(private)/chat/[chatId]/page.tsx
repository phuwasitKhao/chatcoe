            ...
            const loadChats = async () => {
                try {
                    ...
                    if (data.chats && data.chats.length > 0) {
                        ...
                        console.log("Found existing chat, redirecting to:", latestChat._id || latestChat.id);
    ...
    const fetchMessages = async () => {
        ...
        try {
            ...
            if (data.messages && data.messages.length > 0) {
                const formattedMessages = data.messages.map((msg: { content: string; senderId: string }) => ({
                    text: msg.content,
